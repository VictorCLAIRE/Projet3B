...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        ?>
            <button class="btn btn-secondary my-2 my-sm-0 btnConnecte">Vous êtes connecté/e avec l'adresse mail: <?=$_SESSION['email']?></button>
            <a  class="btn btn-secondary my-2 my-sm-0 btnDeconnexion " href="deconnexion.php">Deconnexion</a> 
        <?php   
        }else{
        ?>
            <a  class="btn btn-secondary my-2 my-sm-0 btnConnexion" href="index.php">Connexion</a> 
        <?php
        }
        ?>
    </nav>
